...
class SNSLinkList extends StatelessWidget {
  SNSLinkList({super.key, this.margin = EdgeInsets.zero, this.padding = EdgeInsets.zero});
  ...
  final List<SNSLink> snsLinks = [
    SNSLink(
      name: "X",
      uri: Uri.https("twitter.com", "/search", {"q": Env.searchKeyword, "src": "typed_query", "f": "live"}),
    ),
    SNSLink(
        name: "note",
